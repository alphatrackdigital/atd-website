    ...
    <>
          ...
          <div className="mx-auto grid max-w-6xl gap-9 lg:my-auto lg:w-full lg:-translate-y-4 lg:grid-cols-[minmax(0,0.95fr)_minmax(420px,480px)] lg:items-center lg:gap-14">
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }} className="pt-2 lg:pt-0">
              ...
              <h1 className="title-safe mt-5 max-w-[36rem] overflow-visible text-balance text-[2.55rem] font-extrabold leading-[1.08] tracking-tight sm:text-5xl md:text-[3.4rem] lg:text-[3.6rem]">
                ...
                <span className="block overflow-visible pb-[0.12em] leading-[1.08] text-gradient-atd-hero sm:whitespace-nowrap">real applications</span>{" "}
                <span className="-mt-[0.04em] block overflow-visible pb-[0.16em] leading-[1.08] text-gradient-atd-hero sm:whitespace-nowrap">and enrolments.</span>
              </h1>
      ...
      <PageSection id="measurement-journey" surface="quiet" spacing="spacious" className="scroll-mt-20 py-16 md:py-24 lg:py-28" containerClassName="px-5 sm:px-6 lg:px-8">
        <SectionIntro
          ...
          title="An application can lose its source before your admissions team ever sees it."
      ...
      <PageSection id="audit-coverage" spacing="spacious" className="relative z-10 scroll-mt-20 py-16 md:py-24 lg:py-28" containerClassName="px-5 sm:px-6 lg:px-8">
        <SectionIntro
          ...
          title="We follow one recruitment journey from click to admissions handoff."
        ...
        <div className="mx-auto mb-16 grid max-w-5xl items-center gap-9 lg:grid-cols-[0.9fr_1.1fr] lg:gap-12">
          <div>
            ...
            <p className="mt-4 max-w-lg text-sm leading-7 text-muted-foreground">
              The scorecard is designed to be useful to a marketing, admissions or student-recruitment lead — not just someone who works in analytics.
            </p>
          </div>
