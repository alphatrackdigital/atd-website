...
const routeImporters = {
  ...
  trackingAuditProfessionalServices: () => import("../pages/TrackingAuditProfessionalServices"),
  trackingAuditEducation: () => import("../pages/TrackingAuditEducation"),
  trackingAuditRealEstate: () => import("../pages/TrackingAuditRealEstate"),
...
const routePrefetchMap: Record<string, RouteImporter[]> = {
  ...
  "/offer/tracking-audit/professional-services": [routeImporters.trackingAuditProfessionalServices],
  "/offer/tracking-audit/education": [routeImporters.trackingAuditEducation],
  "/offer/tracking-audit/real-estate": [routeImporters.trackingAuditRealEstate],
